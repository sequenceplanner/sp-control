...
class URDemoTest(_system: ActorSystem) extends TestKit(_system) with FreeSpecLike with Matchers with BeforeAndAfterAll  with sp.modelSupport.SynthesizeMiniModel {
