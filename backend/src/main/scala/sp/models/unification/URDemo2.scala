...
class Demo(override val system: ActorSystem) extends MiniModel {
  ...
  val urTakeBlue = o("ur.takeBlue", "gripper.close", "ur")(
    c("pre", s"blue == 'atTable1' && ur.actPos == 'at_blue' && gripper.actPos == 'open'"),
  ...
  val urTakeRed = o("ur.takeRed", "gripper.close", "ur")(
    c("pre", s"red == 'atTable1' && ur.actPos == 'at_red' && gripper.actPos == 'open'"),
  ...
  val urTakeYellow = o("ur.takeYellow", "gripper.close", "ur")(
    c("pre", s"yellow == 'atTable1' && ur.actPos == 'at_yellow' && gripper.actPos == 'open'"),
  ...
  val urTakeGreen = o("ur.takeGreen", "gripper.close", "ur")(
    c("pre", s"green == 'atTable1' && ur.actPos == 'at_green' && gripper.actPos == 'open'"),
  ...
  // synthesis
  // reachable states: 785872
  // time to compute: 76.96 seconds
  synthesize("urdemo", false)

  // around 40 seconds to build bdd
  exportNuXmv("urdemo2.smv")
