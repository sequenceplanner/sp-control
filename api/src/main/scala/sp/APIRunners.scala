package sp.runners {
  ...
  object APIRunnerManager {
    ...
    case class SetForceGoal(runnerInstance: ID, goal: Option[String]) extends Request
    ...
    object Formats {
      ...
      implicit lazy val fSetForceGoal:     JSFormat[SetForceGoal]     = Json.format[SetForceGoal]
