...
lazy val domain = Def.setting(PublishingSettings.orgNameFull %%% "sp-domain" % "0.9.4.1")
lazy val comm = Def.setting(PublishingSettings.orgNameFull %%% "sp-comm" % "0.9.4.1")
lazy val gui =  Def.setting(PublishingSettings.orgNameFull %%% "sp-gui" % "0.9.4.1")
lazy val core = Def.setting(PublishingSettings.orgNameFull %%% "sp-core" % "0.9.4.1")
