...
lazy val domain = Def.setting(PublishingSettings.orgNameFull %%% "sp-domain" % "0.9.5-SNAPSHOT")
lazy val comm = Def.setting(PublishingSettings.orgNameFull %%% "sp-comm" % "0.9.5-SNAPSHOT")
lazy val gui =  Def.setting(PublishingSettings.orgNameFull %%% "sp-gui" % "0.9.5-SNAPSHOT")
lazy val core = Def.setting(PublishingSettings.orgNameFull %%% "sp-core" % "0.9.5-SNAPSHOT")
